<?php get_header(); ?>
<div id="main-content-wp" class="checkout-page fixed-layout">
    ...
    <div id="wrapper" class="wp-inner clearfix">
        <form class="d-flex flex-column flex-md-row" method="POST" action="" name="form-checkout">
                ...
                <div class="section-detail">
                    <table class="shop-table">
                        ...
                        <tfoot>
                            ...
                            <tr class="order-total">
                                <td>Khuyến mãi:</td>
                                <td><strong class="total-price">-<?php echo currency_format($cart['info']['percent']); ?></strong></td>
                            </tr>
                            <tr class="order-total">
                                <td>Thành tiền:</td>
                                <td><strong class="total-price"><?php echo currency_format($cart['info']['total'] - $cart['info']['percent']); ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
